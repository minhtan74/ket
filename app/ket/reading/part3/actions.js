...
// Server Action: chấm điểm Reading Part 3 (Matching Functional Language).
// Chấm toàn bộ 100 câu (không còn tách theo từng đề). Đáp án đúng CHỈ được
// lấy ở đây (server), không bao giờ gửi ra client trước đó.

import { getAllQuestions } from '@/lib/models/responseMatching';

const VALID_LETTERS = ['A', 'B', 'C'];

export async function submitPart3(submittedAnswers) {
