...
// Trang chọn quyển KET + Test cho Listening Part 1. Giống hệt Part7Browse -
// accordion: bấm vào 1 quyển KET mới xổ ra danh sách Test bên trong.

import { useState } from 'react';

export default function ListeningPart1Browse({ grouped }) {
            ...
            {isOpen && (
              <div className="p7-ket-panel">
                {testsInGroup.map((t, i) => (
                  <a key={t.id} className="p7-test-btn" href={`/ket/listening/part1?id=${t.id}`}>
